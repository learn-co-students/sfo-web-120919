...
**Minimum Bar:** Create a form that instantiates an object with an association along with the models, migrations, routes, controllers, and views needed to facilitate the form.
