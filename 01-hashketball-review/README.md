...
## Administrative
* Suggestion: don't code along with the lecture (code & video will be uploaded after lecture)
* Lectures are time to learn, labs time to reinforce
* Let us know if we make a mistake in the lecture (typo etc.)
